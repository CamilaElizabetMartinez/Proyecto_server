 ...
 */
class getRouting_LoaderService extends App_KernelProvDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), 'prov');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'prov'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'prov'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'prov'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'prov'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'prov'));
